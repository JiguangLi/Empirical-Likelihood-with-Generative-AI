...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--npiv_penalty_grid", type=int, default=400, help="Grid size used to approximate the spline roughness penalty matrix")
    ...
    ap.add_argument("--save_csv", type=str, default="engel95_npiv_vs_gpt_sbetel_400.csv")
    ap.add_argument("--save_long_csv", type=str, default="engel95_npiv_vs_gpt_sbetel_long_400.csv")
...
if __name__ == "__main__":
    ...
    aug_data_dir = here / "output_engel95_400" / "engel95_gpt_training_bundle_complete.pkl"
